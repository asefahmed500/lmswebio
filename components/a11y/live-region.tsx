...
export function VisuallyHiddenFocus({
  ...
  return (
    <span
      className={`sr-only focus:not-sr-only focus:absolute focus:top-2 focus:left-2 focus:z-50 focus:inline-block focus:rounded focus:bg-primary focus:px-4 focus:py-2 focus:text-primary-foreground ${className} `}
    >
      {children}
    </span>
  )
