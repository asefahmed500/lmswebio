...
export function BadgeDisplay({ badges, showAll = false, maxDisplay = 8 }: BadgeDisplayProps) {
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-4 text-sm">
        <div className="flex items-center gap-2">
          ...
          <span className="font-medium">{earnedBadges.length} / {badges.length} Badges</span>
        </div>
          ...
          <Card className={`cursor-pointer transition-all hover:shadow-md ${
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                <Avatar className={`h-12 w-12 ${badge.earned ? "ring-2 ring-primary" : ""}`}>
