...
export const createSubmissionSchema = z.object({
  ...
  textAnswer: z.string().max(10000, "Text answer must be less than 10,000 characters").optional(),
...
export const gradeSubmissionSchema = z.object({
  ...
  feedback: z.string().max(5000, "Feedback must be less than 5,000 characters").optional(),
})
